...
import com.example.dietiestates.data.model.ListingFormErrors
import com.example.dietiestates.data.model.ListingFormState
...
class ListingViewModel(    savedStateHandle: SavedStateHandle ) : ViewModel() {
    ...
    var imageUrls by mutableStateOf<List<String>>(emptyList())  //foto remote listing
        private set
