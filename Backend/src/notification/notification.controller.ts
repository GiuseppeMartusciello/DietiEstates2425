...
export class NotificationController {
  constructor(private notificationService : NotificationService, private pushNotificationService: PushNotificationService) 
  {}
    ...
    createPromotionalNotification(
      ...
      return this.notificationService.createPromotionalNotification(user, createNotificationDto, listingId);
    }
    ...
    getNotificationById(@Param("notificationsId") notificationId:string): Promise<Notification> {
    ...
    updateNotification(
      ...
      return this.notificationService.updateNotification(user, userNotificationId);
    }
